...
module TTY
  class Prompt
    ...
    #
    # @api private
    class OrderedMultiList < List
      # Create instance of TTY::Prompt::OrderedMultiList menu.
      #
      # @param [Prompt] :prompt
      # @param [Hash] options
      #
      ...
      def keyctrl_r(*)
        ...
        @selected = choices.to_a - @selected
      end
      ...
      def setup_defaults
        ...
        @selected = @choices.values_at(*default_indexes)
      ...
      def render_menu
        ...
        paginator.paginate(choices, @active, @per_page) do |choice, index|
          ...
          message = if @selected.include?(choice) && !choice.disabled?
                      selected = @prompt.decorate(@selected.index(choice) + 1, @active_color)
